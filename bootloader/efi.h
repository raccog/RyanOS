 ...
 * EFI header
 *
 * Work on this header started at a previous project (https://github.com/raccog/asOS)
 *
 ...
 *
 * Many protocols and procedures have not been implemented yet, including the entire list of runtime services. These will be 
